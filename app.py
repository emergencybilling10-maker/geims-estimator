...
def load_live_data(url):
    try:
        # Since you deleted the cover page, we load directly
        df = pd.read_csv(url)
        # Clean up column names (removes spaces and newlines)
...
# GEIMS 2025 Hardcoded Policy Rates (From your General Information)
ROOM_DATA = {
